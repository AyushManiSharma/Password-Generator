...
var Heading = myDocument.querySelector('h1');
var Button = myDocument.querySelector('button');
var Submit = myDocument.querySelector("#submit");
var Generate = myDocument.querySelector("#generate");
var Reset = myDocument.querySelector("#reset");
